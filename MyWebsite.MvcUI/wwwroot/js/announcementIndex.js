$(document).ready(function () {
    ...
    $(document).on('click',
        ...
        function (event) {
            ...
            const announcementTitle = tableRow.find('td:eq(1)').text();
            Swal.fire({
                title: 'Silmek istediğinize emin misiniz?',
                text: `${announcementTitle} başlıklı duyuru silinicektir!`,
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            Swal.fire(
                                'Silindi!',
                                `${announcement.Title} başlıklı duyuru başarıyla silinmiştir.`,
                                'success'
                            );
