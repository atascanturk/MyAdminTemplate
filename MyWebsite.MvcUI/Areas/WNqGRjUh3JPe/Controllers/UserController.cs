...
using MyWebsite.MvcUI.WNqGRjUh3JPe.Admin.Models;
using NToastNotify;
using System;
...
namespace MyWebsite.MvcUI.Areas.WNqGRjUh3JPe.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        [HttpGet]
        public async Task<PartialViewResult> GetDetails(int userId)
        {
        ...
        public async Task<ViewResult> ChangeDetails(UserUpdateDto userUpdateDto)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    _toastNotification.AddSuccessToastMessage($"Bilgileriniz başarıyla düzenlenmiştir.");
        ...
        public async Task<IActionResult> PasswordChange(UserPasswordChangeDto userPasswordChangeDto)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("", "Lütfen girdiğiniz mevcut şifreyi tekrar kontrol ediniz.");
                    return View(userPasswordChangeDto);
                }
            }
